...
import com.CodeCluster.ExecutionService.service.ProblemService;
...
public class JavaContainer implements Container {
    ...
    @Autowired
    public JavaContainer(ProblemService problemService,
    ...
    public String executeProgram(String problemId, String jobId, String code) {
        ProblemsTable problem = problemService.getProblem(problemId);
